  ...
  return function (n) {
    ...
    var m = n(1),
      ...
      var r,
          ...
          c = e & w.P,
          p = e & w.B,
          f = l ? m : s ? m[t] || (m[t] = {}) : (m[t] || {})[_],
          d = l ? v : v[t] || (v[t] = {}),
          h = d[_] || (d[_] = {});

      for (r in l && (n = t), n) {
        i = ((o = !a && f && f[r] !== undefined) ? f : n)[r], u = p && o ? g(i, m) : c && "function" == typeof i ? g(Function.call, i) : i, f && b(f, r, i, e & w.U), d[r] != i && y(d, r, u), c && h[r] != i && (h[r] = i);
      }
    };
    ...
    function r(e, t) {
      ...
      for (t && null != t.children && (s.length || s.push(t.children), delete t.children); s.length;) {
        if ((r = s.pop()) && r.pop !== undefined) for (i = r.length; i--;) {
          s.push(r[i]);
    ...
    function F(e, t, n, r, o) {
      ...
      return !T && c && 1 === c.length && "string" == typeof c[0] && null != l && l.splitText !== undefined && null == l.nextSibling ? l.nodeValue != c[0] && (l.nodeValue = c[0]) : (c && c.length || null != l) && function S(e, t, n, r, o) {
        ...
        if (0 !== m) for (var b = 0; b < m; b++) {
          var g = c[b],
              _ = g["__preactattr_"],
              w = y && _ ? g._component ? g._component.__key : _.key : null;
          null != w ? (d++, f[w] = g) : (_ || (g.splitText !== undefined ? !o || g.nodeValue.trim() : o)) && (p[v++] = g);
        }
        if (0 !== y) for (var b = 0; b < y; b++) {
          l = t[b], s = null;
          var w = l.key;
          if (null != w) d && f[w] !== undefined && (s = f[w], f[w] = undefined, d--);else if (h < v) for (i = h; i < v; i++) {
        ...
        var x, O, C;
        if (d) for (var b in f) {
          f[b] !== undefined && R(f[b], !1);
        }

        for (; h <= v;) {
          (s = p[v--]) !== undefined && R(s, !1);
        }
      }(i, c, n, r, T || null != s.dangerouslySetInnerHTML), function m(e, t, n) {
        var r;
      ...
      if (!e._disable) {
        ...
        if (e.constructor.getDerivedStateFromProps && (l = N(N({}, l), e.constructor.getDerivedStateFromProps(a, l)), e.state = l), d && (e.props = c, e.state = p, e.context = f, 2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(a, l, s) ? y = !0 : e.componentWillUpdate && e.componentWillUpdate(a, l, s), e.props = a, e.state = l, e.context = s), e.prevProps = e.prevState = e.prevContext = e.nextBase = null, e._dirty = !1, !y) {
          ...
          if ("function" == typeof w) {
            var x = M(o);
            (i = v) && i.constructor === w && x.key == i.__key ? U(i, x, 1, s, !1) : (g = i, e._component = i = D(w, x, s), i.nextBase = i.nextBase || h, i._parentComponent = e, U(i, x, 0, s, !1), V(i, 1, n, !0)), _ = i.base;
          } else u = m, (g = v) && (u = e._component = null), (m || 1 === t) && (u && (u._component = null), _ = function B(t, n, r, o, i, u) {
          ...
          if (m && _ !== m && i !== v) {
            var O = m.parentNode;
            O && _ !== O && (O.replaceChild(_, m), g || (m._component = null, R(m, !1)));
          }
          ...
          if (g && q(g), (e.base = _) && !r) {
            ...
            _._component = C, _._componentConstructor = C.constructor;
          }
        }

        for (!d || n ? A.unshift(e) : y || (e.componentDidUpdate && e.componentDidUpdate(c, p, b), E.afterUpdate && E.afterUpdate(e)); e._renderCallbacks.length;) {
    ...
    e.exports = function (p, e) {
      var f = 1 == p,
          ...
          b = e || r;
      return function (e, t, n) {
        for (var r, o, i = w(e), u = _(i), a = g(t, n, 3), l = x(u.length), s = 0, c = f ? b(e, l) : d ? b(e, 0) : undefined; s < l; s++) {
          if ((y || s in u) && (o = a(r = u[s], s, i), p)) if (f) c[s] = o;else if (o) switch (p) {
            case 3:
              return !0;
    ...
    e.exports = !o || n(4)(function () {
      ...
      for (var n = m(e), r = arguments.length, o = 1, i = d.f, u = h.f; o < r;) {
        for (var a, l = v(arguments[o++]), s = i ? f(l).concat(i(l)) : f(l), c = s.length, p = 0; p < c;) {
    ...
    var l = function (n) {
      ...
      return t.isQueryAnOption = function (e, t) {
        ...
        if (clearTimeout(this.$blurInput), !l) {
          var s = o && Z(),
              c = Z() ? u : this.templateInputValue(i[a]);
        ...
        return c && "string" == typeof (e = y({
          ...
          tSelectedOption: h,
          tResults: m
        }), Q && (0, G.createElement)("span", null, (0, G.createElement)("input", {
          className: W,
          readonly: !0,
          tabIndex: "-1",
          value: K
          ...
          "aria-activedescendant": !!R && u + "__option--" + g,
          ...
          var n = (-1 === g ? C === t : g === t) && null === _ ? " " + q + "--focused" : "",
              r = t % 2 ? " " + q + "--odd" : "",
        ...
        }), P && (0, G.createElement)("li", {
          className: q + " " + q + "--no-results"
        }, p())), (0, G.createElement)("span", {
          id: "assistiveHint",
          style: {
            display: "none"
          }
    ...
    e.exports = Object.create || function (e, t) {
      var n;
      return null !== e ? (l[s] = o(e), n = new l(), l[s] = null, n[a] = e) : n = _c(), t === undefined ? n : i(n, t);
    };
  }, function (e, t, n) {
    var u = n(8),
        a = n(9),
    ...
    var r = function r(o, i, u) {
      ...
      return t.componentWillMount = function () {
        ...
        var e = this.props,
            ...
            v = o ? l(o, t, i) : "",
            y = null;
        return y = h ? u(r) : m ? a() : s(t, v), this.debounceStatusUpdate(), (0, b.createElement)("div", {
          style: {
            border: "0",
            clip: "rect(0 0 0 0)",
            height: "1px",
